 ...
 *
 */
public class TestSaveWindow extends AbstractSaveWindow
{
    /**
     * Constructor
     * @param w Breite
     * @param h Höhe
     */
    public TestSaveWindow(final int w, final int h)
    {
        super(w, h);
    ...
    public void onSelectionFinished(File selected)
    {
        ...
        fileNameField.setText(unixfyPath(selected.getAbsolutePath()) + "/Beispiele");
    }
