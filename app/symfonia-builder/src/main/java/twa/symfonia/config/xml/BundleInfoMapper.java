...
public class BundleInfoMapper
{
    ...
    /**
     * Versucht alle Bundles in einem Ordner einzulesen und gibt im Erfolgsfall
     * eine Liste von Bundles zurück.
     * 
    ...
    /**
     * Wendet einen XPath auf das übergebene XML-Dokument an und gibt das
     * Ergebnis zurück.
     * 
    ...
    /**
     * Gibt eine Liste von Bundle-Ordnern zurück. Der Name eines Bundles muss
     * immer entweder mit "bundle" oder mit "addon" beginnen und es muss ein
     * Dateiordner sein.
     * 
     * @param path Pfad des Ordners
