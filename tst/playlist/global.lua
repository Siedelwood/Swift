...
function StartTestEventMusic()
    -- Sound.MusicStartEventPlaylist("config/sound/qsbs_playlist_test.xml");
    API.StartEventPlaylist("config/sound/qsbs_playlist_test.xml");
end

function StopTestEventMusic()
    -- Sound.MusicStopEventPlaylist("config/sound/qsbs_playlist_test.xml");
    API.StopEventPlaylist("config/sound/qsbs_playlist_test.xml");
end