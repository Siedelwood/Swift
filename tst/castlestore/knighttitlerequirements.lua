InitKnightTitleTables = function()
    ...
    KnightTitleRequirements[KnightTitles.Mayor].Entities = {
        {Entities.B_Bakery, 1},
        {Entities.B_Butcher, 1},
        {Entities.B_Dairy, 1},
        {Entities.B_SmokeHouse, 1},
    }
    ...
    KnightTitleRequirements[KnightTitles.Baron].Category = {
        {EntityCategories.Outpost, 1},
    }

    -- Graf --------------------------------------------------------------------

    KnightTitleRequirements[KnightTitles.Earl] = {}
    KnightTitleRequirements[KnightTitles.Earl].Settlers = 65
    KnightTitleRequirements[KnightTitles.Earl].Storehouse = 2
    KnightTitleRequirements[KnightTitles.Earl].Products = {
        {GoodCategories.GC_Entertainment, 18},
        {GoodCategories.GC_Medicine, 9},
    }
    KnightTitleRequirements[KnightTitles.Earl].Consume = {
        {Goods.G_Broom, 32},
        {Goods.G_Soap, 32},
    }
    ...
    KnightTitleRequirements[KnightTitles.Marquees].Settlers = 90
    KnightTitleRequirements[KnightTitles.Marquees].Headquarters = 2
    KnightTitleRequirements[KnightTitles.Marquees].RichBuildings = 12
    KnightTitleRequirements[KnightTitles.Marquees].Category = {
        {EntityCategories.Outpost, 3},
        {EntityCategories.CattlePasture, 10},
        {EntityCategories.SheepPasture, 10},
    }
    ...
    KnightTitleRequirements[KnightTitles.Duke].Storehouse = 3
    KnightTitleRequirements[KnightTitles.Duke].Reputation = 100
    KnightTitleRequirements[KnightTitles.Duke].DecoratedBuildings = {
        {Goods.G_Banner, 9 },
    }
    KnightTitleRequirements[KnightTitles.Duke].Entities = {
        {Entities.B_Theatre, 2},
    }
    KnightTitleRequirements[KnightTitles.Duke].Category = {
        {EntityCategories.Spouse, 20},
    }

    -- Erzherzog ---------------------------------------------------------------

    KnightTitleRequirements[KnightTitles.Archduke] = {}
    KnightTitleRequirements[KnightTitles.Archduke].RichBuildings = 20
    KnightTitleRequirements[KnightTitles.Archduke].FullDecoratedBuildings = 20
    KnightTitleRequirements[KnightTitles.Archduke].Buff = {
        Buffs.Buff_FoodDiversity,
        Buffs.Buff_HygieneDiversity,
        Buffs.Buff_ClothesDiversity,
        Buffs.Buff_EntertainmentDiversity,
    }
