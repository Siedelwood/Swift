...
function BriefingTest(_Name, _PlayerID)
    ...
    AAN("SpecialNamedPage1", "HarborMaster", -60, 2000, 35, "HarborMaster", -30, 2000, 25, 30);

    ASP("SpecialNamedPage2", "Page 2", "WOW! That is very cool.");
    AAN("SpecialNamedPage2", true);
    AAN("SpecialNamedPage2", "Leon", -45, 6000, 35, "Leon", -45, 3000, 35, 30);
...
function DialogTest(_Name, _PlayerID)
    ...
    ASP(8, "HarborMaster", "NPC", "I aren't done drowning you in useless text.", true);
    ASP(1, "HarborMaster", "Leon", "Maybe I should make your fat neck spin...", true);
